...
{		
		...
		typedef struct {
			...
			byte 	HorFSwitchId;
			byte 	ActiveWhenHorFSwichIsPressed;
			byte	WorkstationId;
			byte 	TotalNumOfExpDBinProcedure;
			byte 	GenDataBankSequencing;
		 ...
		 */
		virtual byte II_Patient_SS_ProcedureDefinition( tProcedure *pProcedure ) { return Cp_MessageNotAvailable; } 
	
		/*!
		 * \brief Gets procedure Id Information
		 */
		virtual byte II_Patient_SS_ProcedureDefinition( byte ProcedureId ) { return Cp_MessageNotAvailable; } 
		 ...
		 */
		virtual byte II_Patient_SS_ProcedureActivateDatabank(byte ProcedureId , byte Command , byte ExpDBSeqNum )  { return Cp_MessageNotAvailable; } 
	
		/*!
		 *	\brief Gets Current Status of Procedure & Databank
		 */
		virtual byte II_Patient_SS_ProcedureActivateDatabank(byte ProcedureId )  { return Cp_MessageNotAvailable; } 
		 ...
		 */
		virtual byte II_Patient_SS_Procedure_Default( byte ProcedureId , byte Command , byte ExpDBSeqNum ) { return Cp_MessageNotAvailable; } 
	
		/*!
		 * \brief Gets Default Procedure
		 */
		virtual byte II_Patient_SS_Procedure_Default( void ) { return Cp_MessageNotAvailable; }
		 ...
		 */
		virtual byte II_Patient_SS_Procedure_ClearAll (void) { return Cp_MessageNotAvailable; }
		 ...
		 *		   Each positioner and generator will reply with a Positioner Procedure and Generator Procedure ANSWER-EVENT.
		 */
		virtual byte II_Patient_SS_Patient_Redefine_HandFootswitchActivation( byte ProcedureId , byte ActiveWhenHorFSwitchIsPressed ) { return Cp_MessageNotAvailable; }
		 ...
		 *		  Each positioner and generator will reply with a Positioner Procedure and Generator Procedure ANSWER-EVENT.
		 */
		virtual byte II_Patient_SS_Redefine_Workstation(byte ProcedureId , byte WorkstationId ) { return Cp_MessageNotAvailable; }
		 ...
		 * \brief This message is sent to positioner request a complete update of the current positioner status. 
				  ...
				  This includes defined procedures and data banks.
		 */
		virtual byte II_Patient_SS_SyncUp( void ) { return Cp_MessageNotAvailable; }
	
		/*!
		 * \brief Sets new Working Mode
		 */
		virtual byte II_Patient_SS_WorkingMode(byte WorkingMode , byte NodeId) { return Cp_MessageNotAvailable; }
			
		/*!
		 *\brief Gets Current Working MOde
		 */
		virtual byte II_Patient_SS_WorkingMode(void) { return Cp_MessageNotAvailable; };
		...
		virtual byte II_Positioner_Calibration_Number( byte Pos_Id , byte Sequence ) { return Cp_MessageNotAvailable; }
		
		/*!
		 * \brief Gets Positioner Calibration Number
		 */
		virtual byte II_Positioner_Calibration_Number( void ) { return Cp_MessageNotAvailable; }
		 ...
		 */
		virtual byte II_Patient_SS_PowerOffRequest( tPowerOffType PowerOffType ){}
		 ...
		 */ 
		virtual byte II_Patient_SS_PowerOff( unsigned short WaitTimeBeforePowerOff ){ return Cp_MessageNotAvailable; } 
		/*!
		 ...
		 */
		virtual byte II_Patient_SS_PowerOffCancel(void) { return Cp_MessageNotAvailable; } 
		 ...
		 */
		virtual byte II_Patient_SS_PowerOffConfirm( tPowerOffType PowerOffConfirmType) { return Cp_MessageNotAvailable; }
	};
};//namesapce
