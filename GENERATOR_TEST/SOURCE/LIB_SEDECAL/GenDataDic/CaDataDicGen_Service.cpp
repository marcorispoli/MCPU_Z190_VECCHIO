...
namespace R2CP
{
	...
	void CaDataDicGen::Service_StandardLicense	( tDataDicAccess Access, byte *pData, word nData,  tInfoMessage *MessageInfo )
	{
	...
	void CaDataDicGen::Service_ExtendedLicense ( tDataDicAccess Access, byte *pData, word nData,  tInfoMessage *MessageInfo )
	{
		if(MessageInfo == nullptr)
			return;
	...
	//Events
	void CaDataDicGen::Service_Log_Event(byte *ServiceLog , word SizeofLog)
	{
