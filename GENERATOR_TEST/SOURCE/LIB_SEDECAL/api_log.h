...
#include "../Typedef.h"
  ...
  namespace Api
  {
	  ...
	  public:
		  ...
		  static void Set_System_Level(Log_level new_level = Log_level::Info , Output output = Output::Serial_Port , void (*LogByEthernet)(byte , char*) = nullptr);
		  
	  private:
		  static Log_level system_level_;
		  static Output log_output_;
		  static void (*fcb_LogByEthernet_)(byte , char*);
	  };
  }
